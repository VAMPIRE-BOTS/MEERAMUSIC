...
from AarumiMusic.utils.formatters import convert_bytes
from AarumiMusic.utils.inline.song import song_markup

mycookies = "AarumiMusic/cookies.txt"
...
async def song_download_cb(client, CallbackQuery, _):
    ...
    with yt_dlp.YoutubeDL({"cookiefile": "AarumiMusic/cookies.txt", "quiet": True}) as ytdl:
